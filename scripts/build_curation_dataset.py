...
REVIEW_COLUMNS = [
    ...
    "official_test_standard",
    "official_condition_temperature_C",
    "official_condition_atmosphere",
    "official_gauge_length_mm",
    "official_strain_rate_s_inv",
    "official_specimen_id",
    "official_sample_batch_id",
    "official_specimen_linkage",
    "official_measurement_direction",
    "official_density_basis",
    "official_cross_section_method",
    "official_normalization_basis",
    "official_value_bound_type",
    "official_statistic_type",
    "official_sample_size_n",
